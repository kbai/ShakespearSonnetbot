...
It is clear that each of the 5 hidden states have peaks in different positions of a sentence. State 2 is most likely to be the starting word of a sentence while state 4 end of a sentence. But we can expect that if the number of hidden state is greater, they may be representing some other meanings and may bear some sentimental meanings. 
 \begin{figure}[h!]
 \centering
